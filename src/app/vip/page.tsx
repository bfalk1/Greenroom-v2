...
export default function VipOfferPage() {
  ...
  const startCheckout = async (priceId: string, lifetime: boolean) => {
    if (!priceId) return;
  ...
  const handleSelect = (pkg: Pkg) => {
    if (pkg.tierName === "VIP") {
      ...
      startCheckout(pkg.priceId, false);
    }
  };

  const confirmLifetime = () => {
    setShowTerms(false);
    startCheckout(VIP_LIFETIME_OFFER.priceId, true);
  };
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#a1a1a1]">
              An exclusive offer for our returning subscribers. Enter your
