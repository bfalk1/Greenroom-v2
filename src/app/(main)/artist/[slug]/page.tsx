...
function SampleRow({
  ...
  useEffect(() => {
    ...
    fetch("/api/favorites")
      .then((res) => res.json())
      .then((data) => {
        if (data.sampleIds?.includes(sample.id)) {
          setIsFavorited(true);
        }
      })
      .catch(() => {});
          ...
          {samples.length > 0 ? (
            <div className="bg-[#1a1a1a] rounded-lg border border-[#2a2a2a] overflow-hidden">
              ...
              <div className="grid grid-cols-[auto_1fr_80px_60px] md:grid-cols-[auto_1fr_90px_45px_45px_80px_50px] gap-2 md:gap-3 px-3 md:px-4 py-3 border-b border-[#2a2a2a] bg-[#141414]">
                ...
                <div className="text-xs font-medium text-[#a1a1a1]">Name</div>
                <div className="hidden md:block text-xs font-medium text-[#a1a1a1]">Genre</div>
                <div className="hidden md:block text-xs font-medium text-[#a1a1a1]">Key</div>
                <div className="hidden md:block text-xs font-medium text-[#a1a1a1]">BPM</div>
                <div className="hidden md:block text-xs font-medium text-[#a1a1a1]">★</div>
