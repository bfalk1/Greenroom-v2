...
interface LandingPageContentProps {
  /** Where every "join / get started / browse" CTA points. The promo funnel
   *  sends them to /promo/pricing so the intro discount survives the click. */
  ctaHref?: string;
  /** Prefixes every landing_cta_clicked value ("promo_hero_pricing") so the
   *  promo variant is separable from the public landing page in PostHog. */
  ctaPrefix?: string;
  /** Where the logo points — /promo keeps promo visitors inside the funnel. */
  homeHref?: string;
  /** Rendered immediately below the hero — the promo page's VIP offer band. */
  afterHero?: ReactNode;
}
...
export default function LandingPageContent({
  ...
  const trackCta = (cta: string) => trackLandingCta(`${ctaPrefix}${cta}`);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!controller.signal.aborted) await loadDevFallback();
      }
    })();
          ...
          <div className="relative mx-auto max-w-5xl">
            ...
            <Reveal delay={200}>
              <div className="mt-6 text-center">
                <Link
                  href={ctaHref}
                  onClick={() => trackCta("preview_browser")}
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
              ...
              <Reveal delay={160}>
                <Link
                  href={ctaHref}
                  onClick={() => trackCta("creators_more")}
                  className="group inline-flex items-center gap-2 text-sm font-semibold text-[#c9c9c9] transition hover:text-[#39b54a]"
                >
                  Browse all creators
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <Reveal delay={200}>
              <Link
                href="/creator/apply"
                onClick={() => trackCta("creator_apply")}
        ...
        <div className="relative z-10 mx-auto max-w-2xl">
          ...
          <Reveal delay={240}>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href={ctaHref}
                onClick={() => trackCta("final_pricing")}
      ...
      <footer className="border-t border-white/5 bg-[#050505] px-5 py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-6 text-sm text-[#777]">
            <Link href={ctaHref} className="transition hover:text-white">Pricing</Link>
          </div>
